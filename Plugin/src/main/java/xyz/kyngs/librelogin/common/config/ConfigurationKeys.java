...
/**
 * All the keys for the configuration. BTW: Most of the comments were generated
 * by GitHub's Copilot :D
 */
...
OFFLINE - Generates a UUID based on the player's name, the same method as if the server was in offline mode
MOJANG - If the player exists in the Mojang's database, it will be used. Otherwise, OFFLINE will be used.
""",
                    ConfigurateHelper::getString);
...
""",
    ...
    public static final ConfigurationKey<Boolean> AUTO_REGISTER
            = new ConfigurationKey<>(
                    ...
                    !!OFFLINE PLAYERS WILL NOT BE ABLE TO REGISTER PREMIUM USERNAMES!!
                    """,
                    ConfigurateHelper::getBoolean);
